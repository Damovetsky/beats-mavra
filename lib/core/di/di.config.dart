...
import 'package:beats/data/module/firebase_module.dart' as _i20;
...
import 'package:beats/data/service/auth_sevice/auth_service.dart' as _i12;
import 'package:beats/data/service/beats_service/beats_service.dart' as _i13;
import 'package:beats/data/service/users_service/exceptions.dart' as _i11;
...
import 'package:beats/view/profile_page/cubit/cubit.dart' as _i19;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i11.UsersExceptionFactory>(() => _i11.UsersExceptionFactory());
    gh.factory<_i12.AuthService>(
        () => _i12.AuthServiceImpl(gh<_i8.FirebaseAuth>()));
    gh.factory<_i13.BeatsService>(
        () => _i13.BeatsServiceImpl(gh<_i9.FirebaseFirestore>()));
    gh.lazySingleton<_i14.ProfileRepository>(
        () => _i15.ProfileRepositoryImpl(gh<_i12.AuthService>()));
    gh.factory<_i16.UserService>(() => _i16.UserServiceImpl(
          gh<_i9.FirebaseFirestore>(),
          gh<_i11.UsersExceptionFactory>(),
        ));
    gh.lazySingleton<_i17.UsersRepository>(
        () => _i18.UsersRepositoryImpl(gh<_i16.UserService>()));
    gh.factory<_i19.ProfileCubit>(
        () => _i19.ProfileCubit(gh<_i14.ProfileRepository>()));
    return this;
  }
}
